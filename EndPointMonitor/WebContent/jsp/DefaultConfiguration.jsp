...
<div>
	...
	<form name="EPMConfigurationForm" onsubmit="return validateForm();"
		action="../ModifyDefaultConfigServlet">
...
<td>Response Time</td><td>&nbsp;&nbsp;: <input type="text" name="responsetime" maxlength="20" /></td>
 ...
 <tr height="50">
<td width="200">
<td>Default Response Time</td><td>&nbsp;&nbsp;: <input type="text" name="defaultresponsetime" maxlength="20" value="<%=st.nextElement()%>" /></td><td width="40"></td>
<td>Average Criterion</td><td>&nbsp;&nbsp;: <input type="text"
				name="averagecreation" maxlength="15" value="<%=st.nextElement()%>" /></td>
</tr>
<tr height="50">
<td width="200">
<td>Time Window Length In Seconds</td><td>&nbsp;&nbsp;: <input type="text" name="timewindowlength" maxlength="15" value="<%=st.nextElement()%>" /></td><td width="40"></td>
<td>Number Of Samples</td><td>&nbsp;&nbsp;: <input type="text" name="noofsamples" maxlength="15" value="<%=st.nextElement()%>" /></td>
</tr>
<tr height="50">
<td width="200">
<td>Enable EPM Engine</td><td>&nbsp;&nbsp;: <input type="text" name="enableepmengine" maxlength="1" value="<%=st.nextElement()%>" /></td><td width="40"></td>
